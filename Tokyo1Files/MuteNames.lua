...
if DevMFM:get(Tokyo.."MFM:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevMFM:sadd(Tokyo.."MFM:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevMFM:srem(Tokyo.."MFM:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevMFM:del(Tokyo.."MFM:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevMFM:smembers(Tokyo.."MFM:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevMFM:get(Tokyo.."MFM:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
TokyoName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if TokyoName then 
TokyoNames = DevMFM:smembers(Tokyo.."MFM:Mute:Names"..msg.chat_id_) or ""
if TokyoNames and TokyoNames[1] then 
for i=1,#TokyoNames do 
if TokyoName:match("(.*)("..TokyoNames[i]..")(.*)") then 
...
DevMFM:set(Tokyo.."MFM:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevMFM:del(Tokyo.."MFM:Lock:MuteNames"..msg.chat_id_)
end
end
end
