...
if result.id_ then 
local abbs = DevMFM:get("TokyoTEAM:Photo"..result.id_)
if not result.profile_photo_ then 
if abbs then 
Dev_MFM(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevMFM:del("TokyoTEAM:Photo"..result.id_) 
end
end
...
Dev_MFM(msg.chat_id_, msg.id_, 1, abbs_text[abbs3], 1, 'html')
end  
DevMFM:set("TokyoTEAM:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
